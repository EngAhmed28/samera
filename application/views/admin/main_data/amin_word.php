...
<div class="inner-content">
    ...
    <?php echo form_open_multipart('dashboard/updateamin_word/'.$result['id'],array('class'=>"form-horizontal",'role'=>"form" ))?>

        <div class="col-md-9">
            <div class="layout">
                <div class="form-group">
                    <label>كلمة الأمين العام</label>
...
<?php elseif(! $records): ?>
            <?php echo form_open_multipart('dashboard/addamin_word',array('class'=>"form-horizontal",'role'=>"form" ))?>
       <div class="col-md-9">
                <div class="layout">
                    <div class="form-group">
                        <label>كلمة الأمين العام</label>
        ...
        <?php foreach($records as $record):?>
            <tr>
                ...
                <td data-title="التحكم" class="text-center">
                    ...
                    <a href="<?php echo base_url().'dashboard/updateamin_word/'.$record->id?>" class="btn btn-warning btn-xs col-lg-5"><i class="fa fa-pencil"></i> تعديل</a>
                </td>
            </tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-4" style="font-size: 16px;"> كلمة الأمين العام </div>
