...
<div class="inner-content">
    ...
    <?php echo form_open_multipart('dashboard/updatemagles_goals/'.$result['id'],array('class'=>"form-horizontal",'role'=>"form" ))?>

        <div class="col-md-9">
            <div class="layout">
                <div class="form-group">
                    <label>أهداف المركز</label>
        ...
        <?php foreach($records as $record):?>
            <tr>
                ...
                <td data-title="التحكم" class="text-center">
                    ...
                    <a href="<?php echo base_url().'dashboard/updatemagles_goals/'.$record->id?>" class="btn btn-warning btn-xs"><i class="fa fa-pencil"></i> تعديل</a>
                </td>
            </tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-4" style="font-size: 16px;">أهداف المركز </div>
