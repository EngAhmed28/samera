        ...
        <div class="col-md-9">
            <div class="layout">
                <div class="form-group">
                    <label>كلمة رئيس مجلس الإدارة</label>
        ...
        <?php foreach($records as $record):?>
            <tr>
                ...
                <td data-title="التحكم" class="text-center">
                    ...
                    <a href="<?php echo base_url().'dashboard/updatemanager_word/'.$record->id?>" class="btn btn-warning btn-xs"><i class="fa fa-pencil"></i> تعديل</a>
                </td>
            </tr>
