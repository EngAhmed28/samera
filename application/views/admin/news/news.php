...
<div class="inner-content">
    <?php if(isset($result)):?>
        <?php echo form_open_multipart('dashboard/update_news/'.$result['id'],array('role'=>"form" ));
    ...
    <div class="col-md-4">
        <div class="layout">
            <div class="form-group ">
                ...
                <input type="text" name="news_name" class="form-control col-xs-6 no-padding" value="<?php echo $out['news_name'];  ?>" required=""/>
            </div>
        </div>
    </div>
    <!-------------------------------------------------------------------------------------------------->
            ...
            for($x = 0 ; $x < count($photo) ; $x++){
                if(count($photo) > 1){
                    $td = '<td style="padding-top: 10%px;">
                               <a  href="'.base_url().'dashboard/delete_photo/'.$result['id'].'/'.$x.'"  class="btn btn-danger btn-xs">
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <table id="example" class=" display table table-bordered table-striped table-hover">
                        ...
                        <tr class="info">
                            <th width="2%">#</th>
                            <th  class="">عنوان الخبر</th>
                            <th class="">تاريخ الخبر</th>
                            <th width="30%" class="">التحكم</th>
                            <th width="15%" class="">حالة الخبر</th>
                        ...
                        foreach($records as $record):
                            ...
                            <tr>
                                ...
                                <td data-title="التحكم" class="text-center">
                                    ...
                                    <a href="<?php echo base_url().'dashboard/update_news/'.$record->id?>" class="btn btn-warning btn-xs"><i class="fa fa-pencil"></i> تعديل</a>
                                    <a  href="<?php echo base_url().'dashboard/delete_news/'.$record->id?>" onclick="return confirm('هل انت متأكد من عملية الحذف ؟');" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> حذف</a>
                                </td>
                                <td data-title="" class="text-center">
                                    <a href="<?php echo base_url().'dashboard/suspend_news/'.$record->id.'/'.$class?>" class="btn btn-<?php echo $class ?> btn-xs"><?php echo $title ?> </a>
                                </td>
