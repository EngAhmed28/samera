        ...
        <div class="col-xs-12">
            <div class="col-md-7 col-sm-7 ">
                <a href="">
                    ...
                    <img src="<?php echo  base_url()."uploads/images/".$photo[0];?>"  style="width: 612px;height: 316px;" alt="" class=" r-img-2">
                </a>
                <p class="r-p"><?php echo $result['content']?> </p>
                <?php if(sizeof($photo) > 1){?>
                    ...
                    <?php foreach ($other_news as $row){?>
                        <div class="col-xs-12 r-xs">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-8">
                                <a href="<?php echo base_url()."Web/details/".$row->id."/".$row->type?>" class="r-a"><?php echo $row->title?></a>
                            </div>
                        </div>
                    <?php } ?>
                </div>
