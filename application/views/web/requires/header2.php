                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav ">
                            ...
                            <li class="dropdown">
                                ...
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">كلمــــات <span class="caret"></span></a>
                                <ul class="dropdown-menu">
                                    <li>
        ...
        <div class="slider" >
            <div id="carousel-example-generic" class="carousel slide " data-ride="carousel" data-wrap="true">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active animatable zoomIn">
                        <img src="<?php echo base_url().'asisst/web_asset/img/'  ?>slider/315786d5728bd4e3d5264faf823d59c3.png" alt="...">
                    </div>
                  <!--  <div class="item animatable zoomIn">
                        <img src="<?php echo base_url().'asisst/web_asset/img/'  ?>slider/img1.jpg" alt="...">
                    </div>
                  -->
                </div>
            </div>
